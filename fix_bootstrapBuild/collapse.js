...
(function (global, factory) {
  ...
  const getSelector = element => {
    ...
    if (!selector || selector === '#') {
      ...
      // `globalThis["document"].querySelector` will rightfully complain it is invalid.
  ...
  const getSelectorFromElement = element => {
    ...
    if (selector) {
      return globalThis["document"].querySelector(selector) ? selector : null;
    }
  ...
  const getElementFromSelector = element => {
    const selector = getSelector(element);
    return selector ? globalThis["document"].querySelector(selector) : null;
  };
...
/*
  const getjQuery = () => {
    ...
    if (jQuery && !globalThis["document"].body.hasAttribute('data-bs-no-jquery')) {
      return jQuery;
    }
...
*/
  ...
  EventHandler__default['default'].on(globalThis["document"], EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
